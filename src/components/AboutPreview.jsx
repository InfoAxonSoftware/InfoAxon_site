        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-12 sm:mb-16">
          {statCards.map((s, i) => (
            <motion.div
              ...
              className={`relative min-w-0 group rounded-2xl p-4 sm:p-6 bg-dark-50/60 dark:bg-dark-900/50 border border-dark-100 dark:border-dark-800 ring-1 ${s.ring} hover:shadow-lg transition-all duration-300 overflow-hidden`}
            >
              ...
              <div className="break-words text-dark-400 dark:text-dark-500 text-xs font-medium mt-1">{s.label}</div>
            </motion.div>
          ))}
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-14 xl:gap-20 items-center">
          ...
          >
            ...
            <div className="pl-4 border-l-4 border-primary-500 py-1">
              ...
              <p className="text-dark-600 dark:text-dark-300 text-sm leading-relaxed">{companyInfo.vision}</p>
            </div>
          </motion.div>
          ...
          >
            {pillars.map((p, i) => (
              <motion.div
                ...
                className="min-w-0 p-4 sm:p-5 rounded-2xl bg-dark-50/60 dark:bg-dark-900/50 border border-dark-100 dark:border-dark-800 hover:border-primary-300 dark:hover:border-primary-700 hover:shadow-md transition-all duration-300 group"
              >
                <div>
